...
***REMOVED***
   ...
   *   'Date': function() {
   *     return { 'getTime': getTimeMock ***REMOVED***
   * ***REMOVED***
   * });
   *
...
***REMOVED***
     ...
     */
    function mapClear() {
      this.__data__ = { 'hash': new Hash, 'map': Map ? new Map : [], 'string': new Hash ***REMOVED***
***REMOVED***
...
***REMOVED***
     ...
     */
    function stackClear() {
      this.__data__ = { 'array': [], 'map': null ***REMOVED***
***REMOVED***
...
***REMOVED***
    ...
    function baseIsEqualDeep(object, other, equalFunc, customizer, bitmask, stack) {
      ...
      if (!objIsArr) {
        ...
        if (objTag == argsTag) {
          objTag = objectTag;
    ***REMOVED*** else if (objTag != objectTag) {
  ...
  ***REMOVED***
      if (!othIsArr) {
        ...
        if (othTag == argsTag) {
          othTag = objectTag;
    ***REMOVED*** else if (othTag != objectTag) {
...
***REMOVED***
    ...
    ***REMOVED*** else if (valIsUndef) {
          setLow = isReflexive && (retHighest || isDef);
    ***REMOVED*** else if (computed == null) {
          setLow = false;
    ***REMOVED***
...
***REMOVED***
    ...
    function cloneSymbol(symbol) {
      return _Symbol ? Object(symbolValueOf.call(symbol)) : {***REMOVED***
***REMOVED***
...
***REMOVED***
    ...
    function createAggregator(setter, initializer) {
      return function(collection, iteratee) {
        var result = initializer ? initializer() : {***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED*** else if (isFlip && args.length > 1) {
          args.reverse();
    ***REMOVED***
...
***REMOVED***;
  ...
  ***REMOVED*** else if (bitmask == CURRY_FLAG || bitmask == CURRY_RIGHT_FLAG) {
        result = createCurryWrapper(func, bitmask, arity);
  ***REMOVED*** else if ((bitmask == PARTIAL_FLAG || bitmask == (BIND_FLAG | PARTIAL_FLAG)) && !holders.length) {
  ...
  ***REMOVED***
    ...
    ***REMOVED***
        ...
        ***REMOVED***)) {
            ...
            break;
      ***REMOVED***
    ***REMOVED*** else if (!(arrValue === othValue || equalFunc(arrValue, othValue, customizer, bitmask, stack))) {
          result = false;
          break;
    ***REMOVED***
  ***REMOVED***
...
***REMOVED***
     ...
     * @example
     *
     * var dict = { 'thirty': 30, 'forty': 40, 'fifty': 50 ***REMOVED***
     *
...
***REMOVED***
     ...
     * @example
     *
     * var object = { 'user': 'fred', 'age': 40 ***REMOVED***
     *
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***
  ***REMOVED*** else if (string.indexOf(separator, end) != end) {
