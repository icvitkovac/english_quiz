...
module.exports = function (NAME, wrapper, methods, common, IS_MAP, IS_WEAK) {
  ...
  ***REMOVED*** : KEY == 'add' ? function add(a) { fn.call(this, a === 0 ? 0 : a); return this; }
...
var core = module.exports = { version: '2.5.1' ***REMOVED***
...
***REMOVED***
    var Zone = (function () {
        function Zone(parent, zoneSpec) {
            ...
            this._properties = zoneSpec && zoneSpec.properties || {***REMOVED***
            this._zoneDelegate =
  ...
  ***REMOVED***
        Zone.prototype.run = function (callback, applyThis, applyArgs, source) {
            ...
            _currentZoneFrame = { parent: _currentZoneFrame, zone: this ***REMOVED***
            try {
...
***REMOVED***;
    var ZoneDelegate = (function () {
        function ZoneDelegate(zone, parentDelegate, zoneSpec) {
            this._taskCounts = { 'microTask': 0, 'macroTask': 0, 'eventTask': 0 ***REMOVED***
            this.zone = zone;
...
***REMOVED***
    ...
    //////////////////////////////////////////////////////
    //////////////////////////////////////////////////////
    var NO_ZONE = { name: 'NO ZONE' ***REMOVED***
    ...
    ***REMOVED***,
***REMOVED***;
    var _currentZoneFrame = { parent: null, zone: new Zone(null, null) ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
        ...
        ***REMOVED***
            ...
            ***REMOVED***
        ***REMOVED***
            catch (e_1_1) { e_1 = { error: e_1_1 ***REMOVED*** }
            finally {
                try {
        ...
        ***REMOVED***);
            ...
            try {
                ...
                ***REMOVED***
                    ...
                    ***REMOVED***
              ***REMOVED*** })(count), reject);
                    count++;
            ***REMOVED***
        ***REMOVED***
            catch (e_2_1) { e_2 = { error: e_2_1 ***REMOVED*** }
            finally {
                try {
...
***REMOVED***());
    ...
    if (!desc || desc.configurable) {
        ...
        if (!desc) {
            desc = { configurable: true, enumerable: true ***REMOVED***
    ***REMOVED***
        desc.get = function () {
...
var zoneSymbolEventNames = {***REMOVED***
...
function patchProperty(obj, prop, prototype) {
    ...
    if (!desc && prototype) {
        ...
        if (prototypeDesc) {
            desc = { enumerable: true, configurable: true ***REMOVED***
    ***REMOVED***
***REMOVED***
...
***REMOVED***
var zoneSymbolEventNames$1 = {***REMOVED***
var globalSources = {***REMOVED***
...
function patchEventTarget(_global, apis, patchOptions) {
    ...
    ***REMOVED***
        ...
        if (typeof delegate === OBJECT_TYPE && delegate.handleEvent) {
            ...
            task.callback = function (event) { return delegate.handleEvent(event); ***REMOVED***
        ...
        var makeAddListener = function (nativeListener, addSource, customScheduleFn, customCancelFn, returnTarget, prepend) {
            ...
            ***REMOVED***
                ...
                if (!symbolEventNames) {
                    ...
                    zoneSymbolEventNames$1[eventName] = {***REMOVED***
...
***REMOVED***
    ...
    ***REMOVED***);
        var req = new XMLHttpRequest();
        var detectFunc = function () { ***REMOVED***
...
***REMOVED***
    ...
    for (var i = 0; i < WTF_ISSUE_555.length; i++) {
        ...
        var targets = globalSources[target] = {***REMOVED***
...
Zone.__load_patch('canvas', function (global, Zone, api) {
    ...
    if (typeof HTMLCanvasElement !== 'undefined' && HTMLCanvasElement.prototype &&
        ...
        patchMacroTask(HTMLCanvasElement.prototype, 'toBlob', function (self, args) {
            return { name: 'HTMLCanvasElement.toBlob', target: self, callbackIndex: 0, args: args ***REMOVED***
    ***REMOVED***);
***REMOVED***
});
...
module.exports = __webpack_require__("../../../../../assets/polyfills.ts");
